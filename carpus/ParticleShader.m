...
- (void)loadShader
{
    [ShaderLoader load:@"ParticleSystem" fshFile:@"ParticleSystem" program:&_program];
    ...
    // Uniforms
    self.u_Intensity = glGetUniformLocation(self.program, "u_Intensity");
